...
export function createPostgresCatalogLicensingVersionFactsRepository(
  ...
  return Object.freeze({
    async findLicensingVersionFacts(catalogProductId, requestedVersion) {
      ...
      try {
        const result = await client.query<LicensingVersionFactsRow>(
          `SELECT
