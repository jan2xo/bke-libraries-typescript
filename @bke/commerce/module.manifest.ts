...
import { COMMERCE_SETTLEMENT_FULFILLMENT_CAPABILITY_ID } from "./contracts/settlement-fulfillment.contract";
import { COMMERCE_SUBSCRIPTION_LIFECYCLE_MANAGEMENT_CAPABILITY_ID } from "./contracts/subscription-lifecycle-management.contract";
import { COMMERCE_SUBSCRIPTION_RENEWAL_PLAN_CAPABILITY_ID } from "./contracts/subscription-renewal-plan.contract";
...
export const commerceModuleManifest = Object.freeze({
  ...
  provides: [
    ...
    COMMERCE_SUBSCRIPTION_RENEWAL_PLAN_CAPABILITY_ID,
